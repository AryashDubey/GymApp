...
public class OutdoorPlankUps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_plank_ups);

        running = false;//timer is not running in the start
        ...
        Basic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!running) {//checking if timer running or not -> if the timer isnt running then we are good to go
                    running = true;//timer has started and will run
                    cw = new CountDownTimer(30000, 1000) {
                        ...
                        public void onFinish() {
                            running = false;//timer is finished and we are all set to start a new timer
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.plankups;
    ...
    public void Update1(){
        running = true;
        //CANCELLING ALL THE TIMER AT ONCE
        cancelTimer1();
        cancelTimer2();
        cancelTimer3();
        cwer = new CountDownTimer(11000, 1000) { //10 Seconds Rest


            public void onTick(long millisUntilFinished) {
                time.setText("Rest for 10 seconds " + millisUntilFinished / 1000);
    ...
    public void Update2(){
        ...
        cancelTimer2();
        cancelTimer3();
        cwe2 = new CountDownTimer(16000, 1000) { //15 Seconds Rest


            public void onTick(long millisUntilFinished) {
                time.setText("Rest for 15 seconds " + millisUntilFinished / 1000);
    ...
    public void Update3(){
        ...
        cancelTimer2();
        cancelTimer3();
        cwe3 = new CountDownTimer(31000, 1000) { //30 Seconds Rest
            public void onTick(long millisUntilFinished) {
                time.setText("Rest for 30 seconds " + millisUntilFinished / 1000);
            }
            public void onFinish() {
