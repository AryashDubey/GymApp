...
public class OutdoorReverseHand extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_reverse_hand);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.reversed;
