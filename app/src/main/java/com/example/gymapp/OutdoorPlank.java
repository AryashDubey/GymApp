...
public class OutdoorPlank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_plank);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.planker;
