...
public class JumpInAndOut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jump_in_and_out);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.jumpinandout;
