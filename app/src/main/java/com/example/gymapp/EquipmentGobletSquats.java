...
public class EquipmentGobletSquats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_equipment_goblet_squats);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.gobletsquat;
