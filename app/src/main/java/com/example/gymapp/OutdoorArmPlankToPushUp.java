...
public class OutdoorArmPlankToPushUp extends AppCompatActivity {
 //   private static final long START_TIME = 800000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_arm_plank_to_push_up);
