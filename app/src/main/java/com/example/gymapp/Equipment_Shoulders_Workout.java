...
public class Equipment_Shoulders_Workout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_equipment__shoulders__workout);
        ...
        backer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent a = new Intent(Equipment_Shoulders_Workout.this, GymWorkout.class);
                startActivity(a);
        ...
        firstArmworkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {   //Opens warmup timer as a offer to warrm up and afterwards the warmup user can skip or skip within the process of warmup
                Intent a = new Intent(Equipment_Shoulders_Workout.this, EquipmentBicepCurls.class);
                startActivity(a);
            }
        });
        ...
        secondArmworkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {   // Opens second workout activity Reverse hand on arm workout
                Intent a = new Intent(Equipment_Shoulders_Workout.this, EquipmentRussianTwist.class);
                startActivity(a);
            }
        });
        thirdArmworkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {   // Opens third workout activity Staggered on arm workout
                Intent a = new Intent(Equipment_Shoulders_Workout.this, EquipmentArmKickBack.class);
                startActivity(a);
            }
        });
        fouthArmworkout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {   // Opens third workout activity Staggered on arm workout
                Intent a = new Intent(Equipment_Shoulders_Workout.this, EquipmentShoulderPushUp.class);
                startActivity(a);
            }
        });
        backer.setOnClickListener(new View.OnClickListener() {
