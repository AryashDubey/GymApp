...
public class OutdoorStaggered extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_staggered);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.staggered;
