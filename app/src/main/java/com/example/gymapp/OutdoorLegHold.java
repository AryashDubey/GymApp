...
public class OutdoorLegHold extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_leg_hold);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.leghold;
