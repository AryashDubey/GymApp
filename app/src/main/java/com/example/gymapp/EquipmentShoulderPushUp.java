...
public class EquipmentShoulderPushUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_equipment_shoulder_push_up);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.shoulderpushup;
