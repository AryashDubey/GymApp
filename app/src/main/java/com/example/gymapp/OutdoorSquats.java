...
public class OutdoorSquats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoor_squats);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.squats;
